...
const prompt1 = "你现在是一名游戏文章编辑，你将会收到一些分割后的html格式的日文文本数据,这些文本都和游戏相关,我需要你执行下面的步骤对文本进行处理: 1.把html转换成markdown格式,需要保留imgs图片地址,如果图片地址没有https开头则加上https://www.inside-games.jp。2.将文本翻译成中文,人名和作品名称不需要翻译。3.优化文本的排版,让文章看起来更美观。"
